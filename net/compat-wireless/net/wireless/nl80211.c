...
static const struct nla_policy nl80211_policy[NL80211_ATTR_MAX+1] = {
	...
	[NL80211_ATTR_P2P_INDEX] = { .type = NLA_U8 },
				       ...
				       u32 threshold)
{
	...
	return rdev->ops->set_cqm_beacon_miss_config(wdev->wiphy, dev, threshold);
}
...
void nl80211_send_p2p_noa_notify(struct cfg80211_registered_device *rdev,
				 struct net_device *netdev,
				 struct cfg80211_p2p_ps *p2p_ps,
				 gfp_t gfp)
{
	...
	hdr = nl80211hdr_put(msg, 0, 0, 0, NL80211_CMD_NOTIFY_NOA);
	if (!hdr) {
		nlmsg_free(msg);
		return;
	}
	...
	NLA_PUT_U8(msg, NL80211_ATTR_P2P_PS_NOA_COUNT, p2p_ps->count);
	NLA_PUT_U32(msg, NL80211_ATTR_P2P_PS_NOA_START, p2p_ps->start);
	NLA_PUT_U32(msg, NL80211_ATTR_P2P_PS_NOA_DURATION, p2p_ps->duration);
	NLA_PUT_U32(msg, NL80211_ATTR_P2P_PS_NOA_INTERVAL, p2p_ps->interval);

	NLA_PUT_U32(msg, NL80211_ATTR_P2P_PS_LEGACY_PS, p2p_ps->legacy_ps);
	NLA_PUT_U32(msg, NL80211_ATTR_P2P_PS_OPP_PS, p2p_ps->opp_ps);
	NLA_PUT_U32(msg, NL80211_ATTR_P2P_PS_CTWINDOW, p2p_ps->ctwindow);

	NLA_PUT_U8(msg, NL80211_ATTR_P2P_INDEX, p2p_ps->index);

	/* Update global structure */
	wdev->p2p_ps.index = p2p_ps->index;
	wdev->p2p_ps.start = p2p_ps->start;
	wdev->p2p_ps.count = p2p_ps->count;
	wdev->p2p_ps.duration = p2p_ps->duration;
	wdev->p2p_ps.interval = p2p_ps->interval;
...
void
nl80211_send_driver_hang_notify(struct cfg80211_registered_device *rdev,
                                gfp_t gfp)
{
	struct sk_buff *msg;
	void *hdr;
	...
	hdr = nl80211hdr_put(msg, 0, 0, 0, NL80211_CMD_NOTIFY_DRIVER_HANG);
	if (!hdr) {
		nlmsg_free(msg);
		return;
	}

 ...
 * @set_cqm_beacon_miss_config: Configure connection quality monitor BEACON
 *	threshold
...
/**
 * cfg80211_get_local_erp - check if ERP protection is used nearby
 * @wiphy: the wiphy
 * @freq: frequency to check
 *
 * This function parses collected informations about APs transmitting
 * on given channel and checks for ERP protection.
 *
 * @returns: aggregated ERP informations for all APs on given frequency.
 *
 */
int cfg80211_get_local_erp(struct wiphy *wiphy, int freq);
...
/**
 * cfg80211_driver_hang_notify - notify upper layers about driver hang
 * @wiphy: wiphy
 * @gfp: context glafs
 *
 * This funciton is called to inform upper layers about driver or FW
 * hang, to perform some actions. E.g reloading driver
 */
void cfg80211_driver_hang_notify(struct wiphy *wiphy,
				 gfp_t gfp);

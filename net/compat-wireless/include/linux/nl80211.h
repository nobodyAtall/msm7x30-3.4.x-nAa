...
/* don't change the order or add anything between, this is ABI! */
	...
	NL80211_CMD_NOTIFY_NOA,
	NL80211_CMD_NOTIFY_DRIVER_HANG,

#if defined(ENABLE_STE_CHANGES) && defined(CONFIG_DATA_PKT_FILTER)
	NL80211_CMD_SET_DATA_FILTER,
#endif
 ...
 * @NL80211_ATTR_STA_WME: Nested attribute containing the wme configuration
 *	of the station, see &enum nl80211_sta_wme_attr.
 * @NL80211_ATTR_UAPSD_SUPPORTED: flag attribute set in device information
 *	indicating that the underlying software supports u-APSD
 * @NL80211_ATTR_QOS_INFO: u8 attribute given for the new station command
 *	giving the QoS info field that the station used to associate, this
 *	is required for u-APSD implementation. Cf. 802.11 7.3.1.17.
 *
...
/* don't change the order or add anything between, this is ABI! */
	...
	NL80211_ATTR_SCAN_RSSI_FILTER,
	NL80211_ATTR_DATA_FILTER,
	NL80211_ATTR_DYNAMIC_PS_TIMEOUT,
 ...
 * @NL80211_ATTR_CQM_BEACON_MISS_THOLD_EVENT: BEACON threshold event
